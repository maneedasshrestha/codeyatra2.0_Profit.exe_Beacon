...
export default function ItemCard({
  ...
  return (
    ...
    >
      {/* Image placeholder – clickable for detail */}
      <div
      ...
      >
        <div
          className="rounded-2xl flex items-center justify-center text-4xl shadow-inner"
          style={{
            width: 72,
            height: 72,
        ...
        {role === "buyer" ? (
          ...
          <div className="mt-auto">
            <button
              ...
              className="w-full py-2.5 rounded-2xl font-semibold text-sm transition-all active:scale-95"
              style={{
                background: "#fef2f2",
                color: "#ef4444",
