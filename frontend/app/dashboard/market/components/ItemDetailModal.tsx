    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ height: 180, background: `linear-gradient(135deg,${bg},${accent}44)` }}
        >
          <div
            className="rounded-2xl flex items-center justify-center"
            style={{ width: 80, height: 80, background: `${accent}33`, boxShadow: `0 4px 24px ${accent}55` }}
          >
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{ color: accent }}>
          ...
          <button
            ...
            style={{ background: "rgba(255,255,255,0.85)", backdropFilter: "blur(6px)", color: "#7c3aed" }}
          >
